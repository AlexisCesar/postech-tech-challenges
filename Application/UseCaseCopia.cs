...
{
    public partial class UseCaseCopia : IClienteUseCases
    {
        private readonly IClientePersistenceGateway ClientePersistancePort;

        public UseCaseCopia(IClientePersistenceGateway clientePersistancePort)
        {
        ...
        public string RetornarBaseadoEmParametro(int i)
        {
            switch (i)
            {
                case 1:
